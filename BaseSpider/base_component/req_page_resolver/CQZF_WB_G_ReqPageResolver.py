...
class CQZF_WB_G_ReqPageResolver(RequestResolver):
    """
    允许自定义代码
    """
    ...
    def general_param(self) -> dict:
        ...
        url = "https://www.ccgp-chongqing.gov.cn/gwebsite/api/v1/notices/stable/new?__platDomain__=www.ccgp-chongqing.gov.cn&endDate=" + END_TIME + "&isResult=2&orBidProject=false&pi=" + str(
